                         ...
                         <div className="space-y-1.5">
                              ...
                              <div className="relative">
                                   ...
                                   <button
                                        ...
                                        onClick={handleAutoGetLocation}
                                        disabled={fetchingLocation}
                                        className="absolute right-2 top-1/2 -translate-y-1/2 p-1.5 text-stone-400 border-none bg-transparent cursor-pointer flex items-center justify-center transition-colors"
