...
import { FiTag, FiX, FiChevronUp, FiCreditCard } from 'react-icons/fi';
...
export const SummaryOrder: React.FC<SummaryOrderProps> = ({
     ...
     const effectivePayment = selectedPayment || (paymentMethods.length > 0 ? paymentMethods[0].key : 'aba');
     ...
     const isActionButtonDisabled =
          ...
          (currentStep >= 2 && !effectivePayment);
     ...
     const renderSummaryCardContent = (isModal: boolean = false) => (
          <div className="px-6 py-6 border border-stone-100 bg-stone-50 rounded-3xl space-y-4 shadow-[0_8px_30px_rgba(0,0,0,0.025)] relative font-kuntomruy">
               {isModal && (
                    <button
               ...
               {/* Always show Payment Methods & Note inside Summary Card */}
               <div className="space-y-4 pt-2 pb-4 border-b border-stone-200/60">
                    ...
                    <div className="space-y-3">
                         {paymentMethods.length === 0 ? (
                              <div className="text-center py-4 text-stone-400 text-xs font-bold uppercase tracking-wider bg-white border border-stone-100 rounded-2xl">
                              ...
                              paymentMethods.map((p, idx) => {
                                   ...
                                   const isSelected = effectivePayment === p.key;

                                   return (
                                        <label
                                             key={p.key}
                                             className={`flex items-center gap-[10px] p-3.5 border rounded-[2px] cursor-pointer transition-all duration-200 ${isSelected
     ...
     return (
          <>
               ...
               <div className="lg:hidden bg-white w-full px-5 py-4 flex items-center justify-between shadow-[0_-8px_30px_rgba(0,0,0,0.03)]">
                    ...
                    <button
                         onClick={() => {
                              if (currentStep >= 2 && !isMobileModalOpen) {
