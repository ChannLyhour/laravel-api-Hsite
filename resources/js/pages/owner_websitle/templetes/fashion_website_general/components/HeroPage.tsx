    ...
    <section className="relative bg-white font-sans overflow-hidden">
      <div className="w-full max-w-7xl mx-auto px-1.5 sm:px-6 lg:px-8 py-4 sm:py-6">
        <div 
          ...
          className="relative h-[150px] sm:h-[450px] lg:h-[420px] w-full rounded-md sm:rounded-md overflow-hidden group/slider bg-stone-100 border border-stone-200/20 cursor-pointer hover:shadow-3xl transition-shadow duration-300 select-none touch-pan-y"
        >
          ...
          {slides.length > 1 && (
            <>
              ...
              <div 
                onClick={(e) => e.stopPropagation()}
                className="absolute bottom-3 right-3 sm:bottom-6 sm:right-6 z-20 flex items-center gap-0.5 sm:gap-1 p-0.5 sm:p-1 rounded-full bg-stone-950/45 backdrop-blur-md border border-white/10 shadow-lg select-none"
              >
