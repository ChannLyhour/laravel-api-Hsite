/**
 * Menu Website Template — Shared TypeScript Types
 *
 * All interfaces used across the templetes_menu template components.
...
/** Lightweight UI-layer item used for product listings */
