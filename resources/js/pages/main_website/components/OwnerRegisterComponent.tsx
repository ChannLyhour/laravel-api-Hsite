      ...
      <div className="w-full max-w-2xl bg-white/80 backdrop-blur-2xl rounded-[5px] border border-slate-200 p-8 sm:p-14 shadow-2xl z-10">
        ...
        <div className="flex items-center justify-between mb-12 pb-6 border-b border-slate-200">
          <div className="flex items-center space-x-4">
            <span className={`w-9 h-9 rounded-[5px] flex items-center justify-center text-xs font-black transition-all ${
              step === 1 ? 'bg-amber-500 text-slate-950 shadow-lg shadow-amber-500/20' : 'bg-emerald-500 text-slate-950'
            }`}>
          ...
          <div className="flex items-center space-x-4">
            <span className={`w-9 h-9 rounded-[5px] flex items-center justify-center text-xs font-black transition-all ${
              step === 2 ? 'bg-amber-500 text-slate-950 shadow-lg shadow-amber-500/20' : 'bg-slate-200 text-slate-500'
            }`}>
              2
            </span>
            <span className={`text-xs font-black tracking-widest uppercase transition-colors ${
