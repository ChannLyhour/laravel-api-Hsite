...
{
    /**
     * Public list of active and published featured deals.
     */
    public function index(Request $request)
    {
        ...
        $deals = FeaturedDeal::where('is_published', true)
    ...
    /**
     * List all featured deals for the logged-in user.
     */
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            $imagePath = UploadHelper::uploadImage($request->file('image'), 'featured-deals');
        ...
        if ($request->hasFile('meta_image')) {
            $metaImagePath = UploadHelper::uploadImage($request->file('meta_image'), 'featured-deals/meta');
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($user->role_id != 1 && $deal->created_by != $user->id) {
            return response()->json(['detail' => 'You do not own this featured deal.'], 403);
        }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        return response()->json(['detail' => 'Featured deal deleted successfully.']);
    }

    /**
     * Associate products to a featured deal.
     */
